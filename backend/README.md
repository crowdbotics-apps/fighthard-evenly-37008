...
## Project Structure
    ...
    ├── fighthard_evenly_37008  # Django project configurations
...
1. Clone this repo and `cd fighthard_evenly_37008`
...
2. Clone this repo and `cd fighthard_evenly_37008`
